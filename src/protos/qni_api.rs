...
impl ::protobuf::Clear for InputRequest {
    fn clear(&mut self) {
        ...
        self.clear_BOOLEAN();
        self.clear_STR();
        self.clear_STR_MAX_LEN();
        self.clear_STR_SELECT();
        self.clear_INT();
        self.clear_INT_MAX_LEN();
        self.clear_FLOAT();
        self.clear_FLOAT_MAX_LEN();
        self.clear_DATE();
        self.clear_DATETIME();
        self.clear_TIME();
        self.clear_COLOR();
...
impl ::protobuf::Clear for ConsolePrintData {
    fn clear(&mut self) {
        self.clear_PRINT();
        self.clear_PRINT_LINE();
        self.clear_PRINT_BUTTON();
        self.clear_NEW_LINE();
        self.clear_DELETE_LINE();
        self.clear_CLEAR_LINE();
        self.unknown_fields.clear();
    }
}
...
impl ::protobuf::Clear for Font {
    fn clear(&mut self) {
        self.clear_font_family();
        self.clear_font_size();
        self.clear_font_style();
        self.unknown_fields.clear();
    }
}
...
impl ::protobuf::Clear for ConsoleSettingItem {
    fn clear(&mut self) {
        ...
        self.clear_BACK_COLOR();
        self.clear_HIGHLIGHT_COLOR();
        self.clear_FONT();
        self.clear_TEXT_ALIGN();
        self.unknown_fields.clear();
    }
}
...
pub enum ConsoleRequest_oneof_data {
    LOAD_STATE(::std::string::String),
    SHARE_STATE(::std::string::String),
    SHARE_STATE_OVERWRITE(::std::string::String),
    DELETE_STATE(::std::string::String),
    GET_STATE(u64),
}
...
impl ConsoleRequest {
    ...
    pub fn clear_LOAD_STATE(&mut self) {
        self.data = ::std::option::Option::None;
    }

    pub fn has_LOAD_STATE(&self) -> bool {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_LOAD_STATE(&mut self, v: ::std::string::String) {
        self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(v))
    }

    // Mutable pointer to the field.
    pub fn mut_LOAD_STATE(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(_)) = self.data {
        } else {
            self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(::std::string::String::new()));
        }
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_LOAD_STATE(&mut self) -> ::std::string::String {
        if self.has_LOAD_STATE() {
            match self.data.take() {
                ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
    ...
    pub fn get_LOAD_STATE(&self) -> &str {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(ref v)) => v,
            _ => "",
        }
    }
    ...
    pub fn clear_SHARE_STATE(&mut self) {
        self.data = ::std::option::Option::None;
    }

    pub fn has_SHARE_STATE(&self) -> bool {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_SHARE_STATE(&mut self, v: ::std::string::String) {
        self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(v))
    }

    // Mutable pointer to the field.
    pub fn mut_SHARE_STATE(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(_)) = self.data {
        } else {
            self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(::std::string::String::new()));
        }
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_SHARE_STATE(&mut self) -> ::std::string::String {
        if self.has_SHARE_STATE() {
            match self.data.take() {
                ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
    ...
    pub fn get_SHARE_STATE(&self) -> &str {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(ref v)) => v,
            _ => "",
        }
    }
    ...
    pub fn clear_SHARE_STATE_OVERWRITE(&mut self) {
        self.data = ::std::option::Option::None;
    }

    pub fn has_SHARE_STATE_OVERWRITE(&self) -> bool {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_SHARE_STATE_OVERWRITE(&mut self, v: ::std::string::String) {
        self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(v))
    }

    // Mutable pointer to the field.
    pub fn mut_SHARE_STATE_OVERWRITE(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(_)) = self.data {
        } else {
            self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(::std::string::String::new()));
        }
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_SHARE_STATE_OVERWRITE(&mut self) -> ::std::string::String {
        if self.has_SHARE_STATE_OVERWRITE() {
            match self.data.take() {
                ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
    ...
    pub fn get_SHARE_STATE_OVERWRITE(&self) -> &str {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(ref v)) => v,
            _ => "",
        }
    }
    ...
    pub fn has_DELETE_STATE(&self) -> bool {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_DELETE_STATE(&mut self, v: ::std::string::String) {
        self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(v))
    }

    // Mutable pointer to the field.
    pub fn mut_DELETE_STATE(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(_)) = self.data {
        } else {
            self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(::std::string::String::new()));
        }
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_DELETE_STATE(&mut self) -> ::std::string::String {
        if self.has_DELETE_STATE() {
            match self.data.take() {
                ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
    ...
    pub fn get_DELETE_STATE(&self) -> &str {
        match self.data {
            ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(ref v)) => v,
            _ => "",
        }
    }
...
impl ::protobuf::Message for ConsoleRequest {
        ...
        while !is.eof()? {
            ...
            match field_number {
                10 => {
                    ...
                    self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::LOAD_STATE(is.read_string()?));
                },
                11 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE(is.read_string()?));
                },
                12 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(is.read_string()?));
                },
                13 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.data = ::std::option::Option::Some(ConsoleRequest_oneof_data::DELETE_STATE(is.read_string()?));
                },
                20 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.data {
            match v {
                &ConsoleRequest_oneof_data::LOAD_STATE(ref v) => {
                    my_size += ::protobuf::rt::string_size(10, &v);
                },
                &ConsoleRequest_oneof_data::SHARE_STATE(ref v) => {
                    my_size += ::protobuf::rt::string_size(11, &v);
                },
                &ConsoleRequest_oneof_data::SHARE_STATE_OVERWRITE(ref v) => {
                    my_size += ::protobuf::rt::string_size(12, &v);
                },
                &ConsoleRequest_oneof_data::DELETE_STATE(ref v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                    "LOAD_STATE",
                    ConsoleRequest::has_LOAD_STATE,
                    ConsoleRequest::get_LOAD_STATE,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                    "SHARE_STATE",
                    ConsoleRequest::has_SHARE_STATE,
                    ConsoleRequest::get_SHARE_STATE,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                    "SHARE_STATE_OVERWRITE",
                    ConsoleRequest::has_SHARE_STATE_OVERWRITE,
                    ConsoleRequest::get_SHARE_STATE_OVERWRITE,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                    "DELETE_STATE",
                    ConsoleRequest::has_DELETE_STATE,
                    ConsoleRequest::get_DELETE_STATE,
                ));
...
impl ::protobuf::Clear for ConsoleRequest {
    fn clear(&mut self) {
        ...
        self.clear_SHARE_STATE_OVERWRITE();
...
pub enum ProgramResponse_oneof_data {
    OK_LOAD_STATE(::protobuf::well_known_types::Empty),
    OK_SHARE_STATE(::std::string::String),
...
impl ProgramResponse {
    ...
    pub fn clear_OK_LOAD_STATE(&mut self) {
        self.data = ::std::option::Option::None;
    }

    pub fn has_OK_LOAD_STATE(&self) -> bool {
        match self.data {
            ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_OK_LOAD_STATE(&mut self, v: ::protobuf::well_known_types::Empty) {
        self.data = ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(v))
    }

    // Mutable pointer to the field.
    pub fn mut_OK_LOAD_STATE(&mut self) -> &mut ::protobuf::well_known_types::Empty {
        if let ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(_)) = self.data {
        } else {
            self.data = ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(::protobuf::well_known_types::Empty::new()));
        }
        match self.data {
            ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_OK_LOAD_STATE(&mut self) -> ::protobuf::well_known_types::Empty {
        if self.has_OK_LOAD_STATE() {
            match self.data.take() {
                ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(v)) => v,
                _ => panic!(),
            }
        } else {
            ::protobuf::well_known_types::Empty::new()
    ...
    pub fn get_OK_LOAD_STATE(&self) -> &::protobuf::well_known_types::Empty {
        match self.data {
            ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(ref v)) => v,
            _ => ::protobuf::well_known_types::Empty::default_instance(),
        }
    }
    ...
    pub fn clear_OK_SHARE_STATE(&mut self) {
        self.data = ::std::option::Option::None;
    }

    pub fn has_OK_SHARE_STATE(&self) -> bool {
        match self.data {
            ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_OK_SHARE_STATE(&mut self, v: ::std::string::String) {
        self.data = ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(v))
    }

    // Mutable pointer to the field.
    pub fn mut_OK_SHARE_STATE(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(_)) = self.data {
        } else {
            self.data = ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(::std::string::String::new()));
        }
        match self.data {
            ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_OK_SHARE_STATE(&mut self) -> ::std::string::String {
        if self.has_OK_SHARE_STATE() {
            match self.data.take() {
                ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(v)) => v,
                _ => panic!(),
            }
        } else {
            ::std::string::String::new()
    ...
    pub fn get_OK_SHARE_STATE(&self) -> &str {
        match self.data {
            ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(ref v)) => v,
            _ => "",
        }
    }
...
impl ::protobuf::Message for ProgramResponse {
    fn is_initialized(&self) -> bool {
        if let Some(ProgramResponse_oneof_data::OK_LOAD_STATE(ref v)) = self.data {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                10 => {
                    ...
                    self.data = ::std::option::Option::Some(ProgramResponse_oneof_data::OK_LOAD_STATE(is.read_message()?));
                },
                11 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    }
                    self.data = ::std::option::Option::Some(ProgramResponse_oneof_data::OK_SHARE_STATE(is.read_string()?));
                },
                12 => {
                    if wire_type != ::protobuf::wire_format::WireTypeLengthDelimited {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.data {
            match v {
                &ProgramResponse_oneof_data::OK_LOAD_STATE(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
                },
                &ProgramResponse_oneof_data::OK_SHARE_STATE(ref v) => {
                    my_size += ::protobuf::rt::string_size(11, &v);
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, ::protobuf::well_known_types::Empty>(
                    "OK_LOAD_STATE",
                    ProgramResponse::has_OK_LOAD_STATE,
                    ProgramResponse::get_OK_LOAD_STATE,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_string_accessor::<_>(
                    "OK_SHARE_STATE",
                    ProgramResponse::has_OK_SHARE_STATE,
                    ProgramResponse::get_OK_SHARE_STATE,
                ));
...
impl ::protobuf::Clear for ProgramResponse {
    fn clear(&mut self) {
        self.clear_OK_LOAD_STATE();
        self.clear_OK_SHARE_STATE();
        self.clear_OK_GET_STATE();
        self.clear_ERR();
        self.unknown_fields.clear();
    }
}
...
impl ::protobuf::ProtobufEnum for FontStyle {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<FontStyle> {
        match value {
            ...
            4 => ::std::option::Option::Some(FontStyle::UNDERLINE),
